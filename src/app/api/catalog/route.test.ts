...
describe('GET /api/catalog', () => {
  ...
  it('returns assembled items for an authenticated user', async () => {
    ...
    mockedList.mockResolvedValue({ items: [{ productId: 'p1', variantId: 'v1', slug: 's', displayName: 'D', description: '', imageUrls: [], sku: 'SKU', packaging: '', categoryId: null, brandId: null, price: { amount: 100, amountExact: '100.00', currency: 'RUB' }, availability: { available: 5, stale: false } }], total: 1 })
